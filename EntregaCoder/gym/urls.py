...
urlpatterns = [
    ...
    path ('piernas/buscador/resultados/', resultado_piernas, name = 'piernas-resultado'),
    ...
    path ('espalda/buscador/resultados/', resultado_espalda, name = 'espalda-resultado'),
    ...
    path ('pecho/resultados/', resultado_pecho, name = 'pecho-resultado')
]